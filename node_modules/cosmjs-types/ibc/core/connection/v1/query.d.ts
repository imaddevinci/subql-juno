...
import { Height, IdentifiedClientState } from "cosmjs-types/ibc/core/client/v1/client";
...
export declare const QueryConnectionResponse: {
    ...
    fromPartial<I extends {
        connection?: {
            ...
            state?: import("cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            counterparty?: {
                clientId?: string | undefined;
                connectionId?: string | undefined;
                prefix?: {
        ...
        connection?: ({
            ...
            } & { [K_1 in Exclude<keyof I["connection"]["versions"][number], keyof import("cosmjs-types/ibc/core/connection/v1/connection").Version>]: never; })[] & { [K_2 in Exclude<keyof I["connection"]["versions"], keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>]: never; }) | undefined;
            state?: import("cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            ...
            } & { [K_4 in Exclude<keyof I["connection"]["counterparty"], keyof import("cosmjs-types/ibc/core/connection/v1/connection").Counterparty>]: never; }) | undefined;
...
export declare const QueryConnectionsResponse: {
    ...
    fromPartial<I extends {
        ...
        connections?: ({
            ...
            } & { [K_1 in Exclude<keyof I["connections"][number]["versions"][number], keyof import("cosmjs-types/ibc/core/connection/v1/connection").Version>]: never; })[] & { [K_2 in Exclude<keyof I["connections"][number]["versions"], keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>]: never; }) | undefined;
            state?: import("cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            ...
            } & { [K_4 in Exclude<keyof I["connections"][number]["counterparty"], keyof import("cosmjs-types/ibc/core/connection/v1/connection").Counterparty>]: never; }) | undefined;
            delayPeriod?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
